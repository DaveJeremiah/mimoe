...
const ACCEPTABLE_ALTERNATIVES: Record<string, string[]> = {
  ...
  "0": ["zero", "zéro", "sifr"],
  "1": ["un", "une", "wahid", "wahed", "one", "1"],
  "2": ["deux", "ithnan", "jouj", "two", "2"],
  "3": ["trois", "thalatha", "tlata", "three", "3"],
  "4": ["quatre", "arba'a", "arbaa", "four", "4"],
  "5": ["cinq", "khamsa", "five", "5"],
  "6": ["six", "sitta", "six", "6"],
  "7": ["sept", "sab'a", "sabaa", "seven", "7"],
  "8": ["huit", "thamaniya", "tmania", "eight", "8"],
  "9": ["neuf", "tis'a", "tesaa", "nine", "9"],
  "10": ["dix", "ashara", "achara", "ten", "10"],
  "11": ["onze", "ahada ashar", "eleven", "11"],
  "12": ["douze", "ithna ashar", "twelve", "12"],
  "13": ["treize", "thirteen", "13"],
  "14": ["quatorze", "fourteen", "14"],
  "15": ["quinze", "fifteen", "15"],
  "16": ["seize", "sixteen", "16"],
  "17": ["dix-sept", "dix sept", "seventeen", "17"],
  "18": ["dix-huit", "dix huit", "eighteen", "18"],
  "19": ["dix-neuf", "dix neuf", "nineteen", "19"],
  "20": ["vingt", "ishroun", "twenty", "20"],
  "30": ["trente", "thalathoun", "thirty", "30"],
  "40": ["quarante", "arba'oun", "forty", "40"],
  "50": ["cinquante", "khamsoun", "fifty", "50"],
  "60": ["soixante", "sittoun", "sixty", "60"],
  "70": ["soixante-dix", "soixante dix", "septante", "seventy", "70"],
  "80": ["quatre-vingts", "quatre vingts", "quatre vingt", "huitante", "eighty", "80"],
  "90": ["quatre-vingt-dix", "quatre vingt dix", "nonante", "ninety", "90"],
  "100": ["cent", "mi'a", "hundred", "one hundred", "100"],
  "1000": ["mille", "alf", "thousand", "one thousand", "1000"],
};
